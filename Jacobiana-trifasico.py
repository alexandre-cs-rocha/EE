...
class Jacobiana():
    ...
    def Derivadas_inj_pot_at(self, jacobiana: np.array, medida_atual: int, index_barra: int, num_buses: int,
                            vet_estados: np.array, barras: pd.DataFrame, nodes: dict, Ybus, baseva, count) -> int:
    ...
    def Derivadas_inj_pot_rat(self, jacobiana: np.array, medida_atual: int, index_barra: int, num_buses: int,
                            vet_estados: np.array, barras: pd.DataFrame, nodes: dict, Ybus, baseva, count) -> int:
        barra1 = barras['nome_barra'][index_barra]
        fases = barras['Fases'][index_barra]
        basekv = barras['Bases'][index_barra]
